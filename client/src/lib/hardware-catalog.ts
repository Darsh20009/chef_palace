...
export const HARDWARE_CATALOG: HardwareDevice[] = [
  ...
  // ─────────────────────── KITCHEN PRINTERS ───────────────────────
  { id: 'epson-tm-t82iii-k', brand: 'Epson', brandAr: 'إبسون', model: 'TM-T82III (Kitchen)', category: 'kitchen_printer', connection: ['lan', 'usb'], protocol: 'ESC/POS', port: 9100, defaultIp: '192.168.1.150', paperWidth: 80, supported: 'full', popular: true, notesAr: 'مطبخ - قسم الأطباق' },
